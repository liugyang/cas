...
<html lang="en">
  ...
  <body>
    ...
    <div class="account-form thumbnail signup">
      <h1>Sign In <br><small>Input your credentials</small></h1>
      <form accept-charset="UTF-8" action="/users" class="form-vertical" id="new_user" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"><input name="authenticity_token" type="hidden" value="1GA/aZXj92pftEapPyb1KWXzzhQBHWdxcWru1V3EOG0="></div> 
        ...
        <div class="control-group">
        <div class="controls">
          <input class="btn btn-primary pull-right" data-disable-with="Signing in..." id="signin_button" name="commit" tabindex="4" type="submit" value="Sign In">
          <label class="checkbox pull-left">
          <input id="stay_signed_in" name="stay_signed_in" tabindex="3" type="checkbox" value="1"> Remember me
          </label>
        </div>
      </div>
    ...
    <div class="account-extras">
      <p>
        <a href="password_resets.html">Forgot password?</a> · Don't have an account? <a href="signup.html">Sign up</a> <br>
      </p>
    </div>
